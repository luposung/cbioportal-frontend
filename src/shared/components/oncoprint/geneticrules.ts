...
export const genetic_rule_set_same_color_for_all_no_recurrence: IGeneticAlterationRuleSetParams = $.extend(
  {},
...
export const genetic_rule_set_same_color_for_all_recurrence: IGeneticAlterationRuleSetParams = $.extend(
  {},
  base_genetic_rule_set_params,
  {
    rule_params: $.extend({}, non_mutation_rule_params, {
...
export const genetic_rule_set_different_colors_no_recurrence: IGeneticAlterationRuleSetParams = $.extend(
  {},
  base_genetic_rule_set_params,
  {
    rule_params: $.extend({}, non_mutation_rule_params, {
...
export const genetic_rule_set_different_colors_recurrence: IGeneticAlterationRuleSetParams = $.extend(
  {},
  base_genetic_rule_set_params,
  {
    rule_params: $.extend({}, non_mutation_rule_params, {
